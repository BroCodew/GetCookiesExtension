...
const Test = () => {
    /* eslint-disable */ console.log(...oo_oo(`709689135_0`, "33333"));
    const [name, setName] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");
    // content.js
    const handleInput = (e) => {
        chrome.runtime.sendMessage({ action: "popup" }, function (response) {
            /* eslint-disable */ console.log(...oo_oo(`709689135_1`, response));
        });
        chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
            chrome.tabs.sendMessage(tabs[0].id, { action: "changeColor" }, function (response) {
                if (response && response.success) {
                    /* eslint-disable */ console.log(...oo_oo(`709689135_2`, "Màu đã được thay đổi thành màu đỏ."));
                }
                else {
